...
class WeixinMpEventNormalizerTest {

  private static final String APP_ID = "wx5823bf96d3bd56c7";
  private final WeixinMpEventNormalizer normalizer = new WeixinMpEventNormalizer("ops-mp", APP_ID);
  ...
  void textMessage() {
    ...
    assertEquals("mp:" + APP_ID + ":user:OPENID1", msg.get().chatId());
